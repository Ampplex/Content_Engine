...
workflow.add_node("hashtag_gen",         hashtag_node)
workflow.add_node("reel_script_gen",     reel_script_node)
workflow.add_node("carousel_gen",        carousel_node)
...
workflow.add_edge("hook_gen",            "hashtag_gen")
workflow.add_edge("hashtag_gen",         "reel_script_gen")   # runs for all formats (skips if not Reel)
workflow.add_edge("reel_script_gen",     "carousel_gen")      # same — skips if not Carousel
workflow.add_edge("carousel_gen",        "critique")
