...
class PostEngagementPredictor:
    ...
    def _train(self):
        logger.info("Training LightGBM PostEngagementPredictor on synthetic data...")
        ...
        logger.info("PostEngagementPredictor trained successfully.")
    ...
    def predict_with_details(self, text: str) -> Dict:
        ...
        importances = dict(zip(POST_FEATURE_NAMES, self.model.feature_importance(importance_type="gain")))
...
class TrendEngagementPredictor:
    ...
    def _train(self):
        logger.info("Training LightGBM TrendEngagementPredictor on synthetic data...")
        ...
        logger.info("TrendEngagementPredictor trained successfully.")
    ...
    def predict_week(self, recent_df: pd.DataFrame) -> list:
        ...
        last_3 = recent_df.tail(3)["engagement_rate"].mean()
